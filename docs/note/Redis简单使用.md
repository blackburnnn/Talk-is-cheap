![image](https://user-gold-cdn.xitu.io/2020/7/26/173893ebf2263cb2?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
<font color='red'>`1）Stack(栈) = LPUSH + LPOP ，FILO先入后出`</font>
